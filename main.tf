# -----------------------------------------------
# main.tf
# Core infrastructure: VPC, subnets, gateways,
# route tables, security groups, and bastion host.
# -----------------------------------------------
...
# Bastion host SG: allows SSH from anywhere (tighten this to your IP in prod)
...
# Private instances SG: only allows traffic from the bastion
